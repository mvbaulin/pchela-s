...
(function(){
	...
	window.addEventListener('scroll', function(){
		if (calculatorArea.getBoundingClientRect().bottom <= calculatorArea.offsetTop - window.variables.menuBar.offsetHeight && calculatorArea.getBoundingClientRect().bottom >= 0) {
